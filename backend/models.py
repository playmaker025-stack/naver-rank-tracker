...
class TrackedProduct(Base):
    ...
    product_name: Mapped[str] = mapped_column(String, nullable=False, comment="앱 표시용 이름 (사용자 편집 가능)")
    naver_title: Mapped[str | None] = mapped_column(String, nullable=True, comment="마지막 수집 시 Naver API 반환 제목 (변경 감지 기준)")
